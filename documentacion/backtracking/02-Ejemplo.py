...
def comprobar(pos_variable):
    ...
    if pos_variable == 0:
        ...
        if not asignacion[0] == asignacion[4] or asignacion[0] == asignacion[5]:
          return False
    ...
    if pos_variable == 2:
        ...
        if not ( asignacion[1] == asignacion[5]):
            return False
    ...
    if pos_variable == 3:
        print("3. posicion C")
        if not asignacion[2] == 8 and  asignacion[2] == asignacion[4]:
            return False
        return True
